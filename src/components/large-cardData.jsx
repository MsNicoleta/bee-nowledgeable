...
const OverlayBeeDetails = [{
  img: Honeybees, title: 'Honeybees',
  description: ['🐝 Honeybees are social insects that live in colonies, with each colony consisting of a queen, worker bees, and drones.\n',
  ...
  img: Bumblebees, title: 'Bumblebees',
  ...
  img: MiningBees, title: 'Mining Bees',
  description: ['🐝 Mining Bees are solitary bees known for their nesting behavior, where females dig tunnels in the ground to create individual nests.\n', 'Solitary Dwellers: Unlike social bees, mining bees do not live in colonies. Each female bee creates her own nest, usually in sandy or loose soil.\n', 'Lesser Known: Mining bees are not as well-known as honeybees or bumblebees, but they play a crucial role in pollination and the ecosystem.\n', 'Quiet Pollinators: Mining bees are generally less aggressive and less likely to sting than other bees, making them a great choice for gardens and urban areas.\n']
},
{
  img: Honeybees, title: 'Honeybees',
  description: ['🐝 Honeybees are social insects that live in colonies, with each colony consisting of a queen, worker bees, and drones.\n',
